    ...
    <div class="max-w-md w-full space-y-8">
      ...
      <div class="bg-white dark:bg-slate-800 shadow-soft rounded-xl p-6 sm:p-8 animate-fade-in">
        <form class="space-y-6" @submit.prevent="handleSubmit">
          ...
          <!-- OIDC Login -->
          <div v-if="oidcEnabled && !isRegistering && !requires2fa" class="relative">
          ...
          <div v-if="oidcEnabled && !isRegistering && !requires2fa">
            <a
              :href="oidcLoginUrl"
              class="btn-secondary w-full py-2.5 justify-center"
            >
...
const oidcEnabled = computed(() => authStore.oidcConfig?.enabled || false)
const oidcLoginUrl = computed(() => authStore.oidcConfig?.loginUrl || null)
